...
namespace Jake2.Qcommon
{
    public class TestRotatePointAroundVector
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine("DEG2RAD:" + Math3D.DEG2RAD(205));
            System.Diagnostics.Debug.WriteLine("testperpendicular...");
            for (int n = 0; n < testperp.length; n++)
                TestPerpend(n, testperp[n]);
            System.Diagnostics.Debug.WriteLine("testrotate...");
